  ...
  → Product (docs/02-product/)        "what to build, and why"
      → Design (docs/05-design/)          "how it should feel and work"
          → Marketing (docs/06-marketing/)    "how the market understands and wants it"
              → Sales (docs/07-sales/)  "how active opportunities are won"
```
...
- **Sales** (`docs/07-sales/`) — marketing creates demand; sales converts qualified interest into closed business. [MARKETING-TO-SALES-HANDOFF.md](MARKETING-TO-SALES-HANDOFF.md) defines the handoff boundary between the two.
